"""dots.ocr adapter using vLLM chat completions."""
...
class DotsOCRAdapter:
    def __init__(self, client: VLLMClient, model_name: str = DEFAULT_DOTS_MODEL) -> None:
        self._client = client
    ...
    def _build_prompt(
        ...
        *,
        ...
        return (
            ...
            "Return JSON only with keys: raw_text, structured_payload, confidence_map.\n"
