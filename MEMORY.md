...
Last updated: 2026-02-15 (updated after T-045)
...
1. `T-046` Curate benchmark dataset (invoice + receipt variants).
2. `T-047` Implement extraction quality evaluation script.
3. `T-048` Add regression thresholds for extraction quality in CI.
4. `T-049` Add integration tests for queue retries and failure states.
